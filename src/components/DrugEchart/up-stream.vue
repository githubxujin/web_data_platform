<template>
    <div class="table-wrap">
        <el-form :inline="true" ref="form" size="medium" class="el-serach-form">
            <el-form-item>
                <el-select v-model="params.companyName" clearable @change="ChangeCompany" filterable placeholder="公司名称" style="width: 200px">
                    <el-option :label="item" :value="item" v-for="(item, index) in companyList" :key="index">
                    </el-option>
                </el-select>
            </el-form-item>
            <el-form-item>
                <el-select v-model="params.companySubname" clearable filterable placeholder="分子公司名称" style="width: 200px">
                    <el-option :label="item" :value="item" v-for="(item, index) in compnaySubnameList" :key="index">
                    </el-option>
                </el-select>
            </el-form-item>
            <el-form-item>
                <el-select v-model="params.agentName" clearable filterable placeholder="客户名称" style="width: 200px">
                    <el-option :label="item" :value="item" v-for="(item, index) in agentList" :key="index">
                    </el-option>
                </el-select>
            </el-form-item>
            <el-form-item>
                <el-select v-model="params.supplierName" clearable filterable remote :remote-method="remoteSupplierName" placeholder="供应商" style="width: 200px">
            ...
            <el-form-item>
                <el-select v-model="fastData" filterable placeholder="快速选择" clearable @change="fastChange" style="width: 200px">
        ...
        <div class="echart-big-wrap p-re" style="margin-top: 30px">
            <div class="up-title">配送公司对上游的采购走势</div>
            <chart height="511px" width="100%" style="margin-top:-39px;" :option="steelPricesOption" id="upStream" />
        ...
        getSteelPricesOption() {
            this.$http("/dcp/drug/purchase/upstream", this.params).then(res => {
                ...
                if (lineData.countList.length && lineData.rateList.length) {
                    ...
                    // drawSteelLine.series.markArea.itemStyle.shadowOffsetY = 100
                    ...
                    if (this.flag === 'dark') {
                        ...
                        drawSteelLine.xAxis.axisLine = this.$medicine.axis;
                        drawSteelLine.xAxis.axisLine.lineStyle.color = ['#ccc'];
                        drawSteelLine.tooltip.axisPointer = {
                            lineStyle: {
                                width: 2,
                                color: {
