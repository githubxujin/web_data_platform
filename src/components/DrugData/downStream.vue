<template>
    <div>
        <c-box type="search">
            ...
            <el-form :inline="true" ref="form" size="mini" class="data-left">
                ...
                <el-form-item label="下游">
                    <el-select v-model="params.customerName" clearable filterable remote :remote-method="remoteCustomerName">
        ...
        <div class="echart-big-wrap p-re">
            <div class="echart-big-title">客户下游订单量与配送量变化趋势</div>
            <chart height="511px" width="1168px" :option="steelPricesOption" id="downStream" />

            <el-row type="flex" justify="space-between" class="tag-box pb20">
                <el-row type="flex" justify="space-between">
                    <c-tag v-for="(v, k) in tagList1" :key="k" :class="{ act: tagCur1 === k }" @click.native="tagHand1(k, v.value)">
                        {{ v.label }}</c-tag>
                </el-row>
                <el-row type="flex" justify="space-between">
