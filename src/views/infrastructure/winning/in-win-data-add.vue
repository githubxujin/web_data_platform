<template>
    <div class="we-template table-wrap mt20 p0">
        <div class="content-top">
            ...
            <div v-else class="template-name">
                <el-input v-model="templateName" autofocus clearable placeholder="请输入模板名称" ref="templateName"></el-input>
            </div>
            ...
            <div class="btn-wrap">
                <el-button type="primary" @click="toSave" ref="templateName1">保存</el-button>
        ...
        <div class="content-bottom">
            <div class="content-bottom-wrap">
                <div class="content-bottom-box" v-for="(item,index) in Object.keys(templateObj)" :key="item">
                    ...
                    <el-date-picker v-model="templateObj[item].configValue" type="date" value-format="yyyy-MM-dd" placeholder="选择日期" v-else-if="item==='recentBidDate'" class="select-op-count">
                    </el-date-picker>
...
export default {
    ...
    methods: {
        ...
        toSave () {
            ...
            this.$http('/dcp/add/stat/template', params).then(res => {
                if (res.code === "200") {
