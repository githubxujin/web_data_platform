<template>
    <div class="table-wrap mt20">
        <div class="table-title">医疗服务数据</div>
        <el-form :inline="true" ref="form" size="medium" class="el-serach-form">
            ...
            <el-form-item class='el-item-form-width'>
                <el-select v-model="params.area" clearable placeholder="地区" filterable>
        ...
        <el-table :data="list">
            ...
            <el-table-column prop="specificIndicators" label="具体指标" show-overflow-tooltip align="left" :formatter="formatLabel"></el-table-column>
            <el-table-column prop="project" label="项目" show-overflow-tooltip align="left" :formatter="formatLabel"></el-table-column>
            <el-table-column prop="area" label="地区" show-overflow-tooltip align="left" :formatter="formatLabel"></el-table-column>
            ...
            <el-table-column prop="year2015" label="2015年" show-overflow-tooltip align="left">
                <template slot-scope="scope">
                    {{numFormat(scope.row.year2015) || '-'}}
                </template>
            </el-table-column>
...
export default {
    ...
    methods: {
        ...
        projectRemote() {
            this.ajax
                .json('/dcp/gsylfusjk/data/vague', { field: 1, project: '' })
                .then(res => {
        ...
        specificIndicatorsRemote() {
            this.ajax
                .json('/dcp/gsylfusjk/data/vague', { field: 2, specificIndicators: '' })
                .then(res => {
        ...
        areaRemote() {
            this.ajax
                .json('/dcp/gsylfusjk/data/vague', { field: 3, area: '' })
                .then(res => {
        ...
        exportData() {
            this.ajax
                .json("/dcp/gsylfusjk/data/export", this.params, { type: "export" })
                .then(res => { });
        },
        reSet() {
            this.params = {
