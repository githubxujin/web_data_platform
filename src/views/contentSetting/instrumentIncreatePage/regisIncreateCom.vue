        ...
        <el-form :model="info" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm mt30 mb20">
            <table class="table-public-detail">
                <tr>
                    <td>注册证编号</td>
                    <td>
                        <el-input v-model="info.registerCode" clearable></el-input>
                    </td>
                    <td>注册人名称</td>
                    <td>
                        <el-input v-model="info.registerName" clearable></el-input>
                    </td>
                </tr>
                <tr>
                    <td>注册人住所</td>
                    <td>
                        <el-input v-model="info.registerAddress" clearable></el-input>
                    </td>
                    <td>生产地址</td>
                    <td>
                ...
                <tr>
                    <td>管理类别</td>
                    <td>
                        <el-input v-model="info.managerCategory" clearable></el-input>
                    </td>
                    <td>型号规格</td>
                    <td>
                ...
                <tr>
                    <td>审批部门</td>
                    <td>
                        <el-input v-model="info.licenseAuthority" clearable></el-input>
                    </td>
                    <td>批准日期</td>
                    <td>
                        <el-form-item>
                            <el-date-picker v-model='info.registerDate' unlink-panels value-format='yyyy-MM-dd' placeholder="选择日期"></el-date-picker>
                        </el-form-item>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <el-form-item>
                            <el-date-picker v-model='info.deadlineDate' unlink-panels value-format='yyyy-MM-dd' placeholder="选择日期"></el-date-picker>
                        </el-form-item>
                    </td>
                    <td>适用范围</td>
                    <td>
                ...
                <tr>
                    <td>结构及主要组成成分</td>
                    <td class="cospan">
                        <el-input v-model="info.constituent" clearable></el-input>
                    </td>
                </tr>
                <tr>
                    <td>变更情况</td>
...
export default {
    ...
    data () {
        return {
            info: {
                ...
                registerCode: '',   //  注册证编号
                registerName: '',   //  注册人名称
                registerAddress: '',    //  注册人住所
                productAddress: '',     //  生产地址
                agentName: '',  //  代理人名称
                agentAddress: '',   //  代理人住所
                managerCategory: '',    //  管理类别
                modelSpecification: '',     //  型号规格
                licenseAuthority: '',   //  审批部门
                registerDate: '',   //  批准日期
                deadlineDate: '',   //  有效期至
                applicationScope: '',   //  使用范围
                other: '',  //  其他
                remark: '',     //  备注
            },
            rules: {
    ...
    methods: {
        ...
        showDetails () {
            let id = this.$route.query.messageId1
            // console.log(id)
            id &&
                this.ajax
                    .post('/dcp/query/apparatusregister/info', { id })
                    .then(res => {
                        if (res.code === '200') {
                            console.log(res);
                            this.info = res.data
        ...
        modifiedData () {
            ...
            // })
            this.ajax
                .json('/dcp/modify/apparatusregister/info', formData, {
                    isLoading: true
                })
                .then(res => {
                    if (res.code === '200') {
