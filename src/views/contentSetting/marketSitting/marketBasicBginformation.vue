    ...
    <div class="table-wrap">
        <div class="mb30">
            ...
            <el-table :data="params.hospitalPeriodList" border class="tab-info">
                <el-table-column prop="paymentType" align="center" label="自由/租赁仓库">
                    <template slot-scope="item">
                        <el-input v-model="item.row.paymentType" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="changeRepaymentAccount" label="仓库面积" width="80" align="center" show-overflow-tooltip>
                    <template slot-scope="item">
                        <el-input v-model="item.row.changeRepaymentAccount" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="changeTime" label="租赁合同时间" align="center" show-overflow-tooltip>
                    <template slot-scope="item">
                        <el-input v-model="item.row.changeTime" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="orgRepaymentMonitor" align="center" label="年租金" show-overflow-tooltip>
                    <template slot-scope="item">
                        <el-input v-model="item.row.orgRepaymentMonitor" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="hospitalContract" align="center" label="仓库成本" show-overflow-tooltip>
                    <template slot-scope="item">
                        <el-input v-model="item.row.hospitalContract" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="hasCommission" label="仓库容量" align="center" show-overflow-tooltip>
                    <template slot-scope="item">
                        <el-input v-model="item.row.hasCommission" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="hasCommission" label="已使用容量" align="center" show-overflow-tooltip>
                    <template slot-scope="item">
                        <el-input v-model="item.row.hasCommission" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="hasCommission" label="仓库自动化程度" align="center" show-overflow-tooltip>
                    <template slot-scope="item">
                        <el-input v-model="item.row.hasCommission" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="hasCommission" label="自有/第三方物流" align="center" show-overflow-tooltip>
                    <template slot-scope="item">
                        <el-input v-model="item.row.hasCommission" clearable></el-input>
                    </template>
                </el-table-column>
            ...
            <el-table :data="params.hospitalBusinessList" border class="tab-info">
                <el-table-column prop="businessYear" label="二级及以上公立医院" width="100" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.businessYear" @change="checkRepetition($event, item.$index, 3)" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="outpatientVisits" label="基层医疗机构" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.outpatientVisits" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="hospitalizations" label="民营医院" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.hospitalizations" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="operatingTable" label="商业公司" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.operatingTable" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="operatingTable" label="药店" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.operatingTable" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="operatingTable" label="其他" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.operatingTable" clearable></el-input>
                    </template>
                </el-table-column>
            ...
            <el-table :data="params.hospitalFinanceList" border class="tab-info">
                <el-table-column type="index" label="序号" width='100' align="center"></el-table-column>
                <el-table-column prop="financeYear" label="业内人员姓名" width="120" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.financeYear" @change="checkRepetition($event, item.$index, 4)" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="netAssets" label="业内人员职位" width="120" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.netAssets" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="totalAssets" label="行业评价" min-width="120" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.totalAssets" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="totalAssets" label="业内人员职位" min-width="120" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.totalAssets" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="totalAssets" label="行业资源" min-width="120" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.totalAssets" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="totalAssets" label="近一年自营品规占比/代打款品规占比" min-width="180" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.totalAssets" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="totalAssets" label="医保目录品种占比" min-width="120" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.totalAssets" clearable></el-input>
                    </template>
                </el-table-column>
