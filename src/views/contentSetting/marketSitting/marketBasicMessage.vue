        ...
        <div class="mb30">
            ...
            <table class="table-public-detail">
                ...
                <tr>
                    <td>企业负责人</td>
                    <td>
                        <el-input v-model="params.hospitalStyle" clearable></el-input>
                    </td>
                </tr>
                <tr>
                    <td>质量负责人</td>
                    <td>
                        <el-input v-model="params.nationalRank" clearable></el-input>
                    </td>
                </tr>
                <tr>
                    <td>企业性质</td>
                    <td>
                        <el-input disabled v-model="params.province" placeholder="不可编辑"></el-input>
                    </td>
                </tr>
                <tr>
                    <td>企业资质</td>
                    <td>
                        <el-input disabled v-model="params.hostUnit" placeholder="不可编辑"></el-input>
                    </td>
                </tr>
                <tr>
                    <td>主营材料/劳务</td>
                    <td>
                        <el-input disabled v-model="params.buildingArea" placeholder="不可编辑"></el-input>
                    </td>
                </tr>
                <tr>
                    <td>客户登记</td>
                    <td>
                        <el-input disabled v-model="params.linkPerson" placeholder="不可编辑"></el-input>
                    </td>
                </tr>
                <tr>
                    <td>融资意愿预测</td>
            ...
            <el-table :data="params.hospitalPeriodList" border class="tab-info">
                ...
                <el-table-column prop="paymentType" align="center" label="姓名" width="100">
                    <template slot-scope="item">
                        <el-input v-model="item.row.paymentType" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="changeRepaymentAccount" label="性别" align="center" show-overflow-tooltip>
                    <template slot-scope="item">
                        <el-input v-model="item.row.changeRepaymentAccount" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="changeTime" label="手机号" align="center" show-overflow-tooltip>
                    <template slot-scope="item">
                        <el-input v-model="item.row.changeTime" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="orgRepaymentMonitor" align="center" label="职位" show-overflow-tooltip>
                    <template slot-scope="item">
                        <el-input v-model="item.row.orgRepaymentMonitor" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="hospitalContract" align="center" label="办公电话" show-overflow-tooltip width="160">
                    <template slot-scope="item">
                        <el-input v-model="item.row.hospitalContract" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="hasCommission" label="拜访地址" align="center" show-overflow-tooltip width="160">
                    <template slot-scope="item">
            ...
            <el-table :data="params.hospitalBusinessList" border class="tab-info">
                <el-table-column type="index" label="序号" width='100' align="center"></el-table-column>
                <el-table-column prop="businessYear" label="股东名称" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.businessYear" @change="checkRepetition($event, item.$index, 3)" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="outpatientVisits" label="认缴金额" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.outpatientVisits" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="hospitalizations" label="实缴金额" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.hospitalizations" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="operatingTable" label="股权占比" align="center">
                    <template slot-scope="item">
            ...
            <el-table :data="params.hospitalFinanceList" border class="tab-info">
                <el-table-column type="index" label="序号" width='100' align="center"></el-table-column>
                <el-table-column prop="financeYear" label="关联公司名称" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.financeYear" @change="checkRepetition($event, item.$index, 4)" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="netAssets" label="关联关系" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.netAssets" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="totalAssets" label="股权结构" align="center">
                    <template slot-scope="item">
