    ...
    <div class="table-wrap">
        <div class="mb30">
            ...
            <el-table :data="params.hospitalPeriodList" border class="tab-info">
                <el-table-column prop="paymentType" align="center" label="实控人名称" width="100">
                    <template slot-scope="item">
                        <el-input v-model="item.row.paymentType" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="changeRepaymentAccount" label="身份证号" align="center" show-overflow-tooltip>
                    <template slot-scope="item">
                        <el-input v-model="item.row.changeRepaymentAccount" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="changeTime" label="婚姻状况" align="center" show-overflow-tooltip>
                    <template slot-scope="item">
                        <el-input v-model="item.row.changeTime" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="orgRepaymentMonitor" align="center" label="子女情况" show-overflow-tooltip>
                    <template slot-scope="item">
                        <el-input v-model="item.row.orgRepaymentMonitor" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="hospitalContract" align="center" label="进入行业年份" show-overflow-tooltip>
                    <template slot-scope="item">
                        <el-input v-model="item.row.hospitalContract" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="hasCommission" label="从业年份" align="center" show-overflow-tooltip>
                    <template slot-scope="item">
            ...
            <el-table :data="params.hospitalBusinessList" border class="tab-info">
                <el-table-column prop="businessYear" label="实控人名称" width="100" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.businessYear" @change="checkRepetition($event, item.$index, 3)" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="outpatientVisits" label="当前贷款是否逾期" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.outpatientVisits" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="hospitalizations" label="过往贷款是否逾期欠息" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.hospitalizations" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="operatingTable" label="逾期或欠息发生时间" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.operatingTable" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="operatingTable" label="逾期欠息信息展示" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.operatingTable" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="operatingTable" label="近6个月贷款审批查询次数" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.operatingTable" clearable></el-input>
                    </template>
                </el-table-column>
            ...
            <el-table :data="params.hospitalFinanceList" border class="tab-info">
                <el-table-column prop="financeYear" label="实控人名称" width="100" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.financeYear" @change="checkRepetition($event, item.$index, 4)" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="netAssets" label="民间借贷" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.netAssets" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="totalAssets" label="不良嗜好" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.totalAssets" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="totalAssets" label="重大负面" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.totalAssets" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="totalAssets" label="被执行人" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.totalAssets" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="totalAssets" label="失信被执行人" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.totalAssets" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="totalAssets" label="反欺诈" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.totalAssets" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="totalAssets" label="被执行人等诉讼信息" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.totalAssets" clearable></el-input>
                    </template>
                </el-table-column>
