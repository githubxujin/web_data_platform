    ...
    <div class="table-wrap">
        <div class="mb30">
            ...
            <el-table :data="params.hospitalBusinessList" border class="tab-info">
                <el-table-column prop="businessYear" label="当前贷款是否逾期" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.businessYear" @change="checkRepetition($event, item.$index, 3)" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="businessYear" label="过往贷款是否逾期欠息" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.businessYear" @change="checkRepetition($event, item.$index, 3)" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="outpatientVisits" label="逾期或欠息发生时间" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.outpatientVisits" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="hospitalizations" label="逾期欠息信息展示" align="center">
                    <template slot-scope="item">
                        <el-input v-model="item.row.hospitalizations" clearable></el-input>
                    </template>
                </el-table-column>
                <el-table-column prop="operatingTable" label="诉讼及负面" align="center">
                    <template slot-scope="item">
