        ...
        <template>
            <div class="stat">
                <div class="table-wrap">
                    <div class="table-title">诉讼关联</div>
                    ...
                    <div>
                        <el-table :data="list" @sort-change="sortChange">
                            ...
                            <el-table-column sortable :sort-method="(a,b)=>{return a.length - b.length}" prop="length" width="100" label="开庭数" show-overflow-tooltip :formatter="formatLabel"></el-table-column>
    ...
    methods: {
        ...
        getList(data = {}) {
            ...
            if (!this.isObjectEmpty(data)) {
                this.ajax
                    .json('/dcp/query/enterprise/relation/court', { evaluateId, ...this.params })
                    .then(res => {
                ...
                this.ajax
                    .json('/dcp/query/enterprise/relation/court', { evaluateId, ...this.params, ...data })
                    .then(res => {
                        this.list = res.data.records;
                        this.total = res.data.total;
                    });
