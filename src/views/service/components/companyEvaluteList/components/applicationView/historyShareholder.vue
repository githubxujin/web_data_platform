        ...
        <template>
            <div class="stat">
                <div class="table-wrap">
                    <div class="table-title">历史股东</div>
                    ...
                    <div>
                        <el-table :data="list" @sort-change="sortChange">
                            ...
                            <el-table-column sprop="crn" label="统一社会信用代码" width="200" show-overflow-tooltip :formatter="formatLabel"></el-table-column>

                            <el-table-column prop="quitDate" label="退出时间" width="150" show-overflow-tooltip :formatter="formatLabel"></el-table-column>
    ...
    methods: {
        ...
        getList(data) {
            ...
            if (!this.isObjectEmpty(data)) {
                this.ajax
                    .json('/dcp/query/enterprise/relation/history/shareholder', { evaluateId, ...this.params })
                    .then(res => {
                ...
                this.ajax
                    .json('/dcp/query/enterprise/relation/history/shareholder', { evaluateId, ...this.params, ...data })
                    .then(res => {
                        this.list = res.data.records;
                        this.total = res.data.total;
                    });
