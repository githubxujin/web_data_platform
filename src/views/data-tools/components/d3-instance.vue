...
export default {
    ...
    methods: {
        fullScreen(flag) {
            ...
            var tree = document.getElementById('product_tree')
            var svg = document.querySelector('#product_tree>svg');
            if (flag === 'full') {
        ...
        scale(type) {
            let width = document.getElementById('product_tree').clientWidth;
            let height = document.getElementById('product_tree').clientHeight;
