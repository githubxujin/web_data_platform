                ...
                <div class="form_content_top">
                    <div class="form_left">
                        ...
                        <el-form-item label="出票人全称" prop="drawerName">
                            <el-input placeholder="请输入出票人" v-model="ruleForm.drawerName" class="input-with-select" style="width: 260px" :disabled="disabled">
                                <el-select v-model="drawerType" slot="prepend" placeholder="请选择出票人类型" style="width: 110px" :disabled="disabled">
                        ...
                        <el-form-item label="标签">
                            <el-select v-model="ruleForm.labelContent" clearable placeholder="请选择标签" :disabled="disabled" style="width: 260px">
                    ...
                    <div class="form_right">
                        ...
                        <el-form-item label="融资企业名称">
                            <el-input v-model="financeCompany" placeholder="请输入融资企业名称" :disabled="disabled" @change="customerNameChange"></el-input>
                        </el-form-item>
                        <el-form-item label="项目名称" prop="projectName">
                            <el-input v-model="ruleForm.projectName" :disabled="disabled" placeholder="请输入项目名称"></el-input>
                        </el-form-item>
                        <el-form-item label="经手企业名称" prop="handleCustomerName">
                            <el-input v-model="ruleForm.handleCustomerName" placeholder="请输入经手企业名称" :disabled="disabled"></el-input>
                        </el-form-item>
                        <el-form-item label="统一社会信用代码" prop="unifiedCreditCode">
                            <el-input v-model="ruleForm.unifiedCreditCode" placeholder="输入企业名称后自动生成" :disabled="disabled"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="收款人开户行" prop="payeeBank">
                            <el-input v-model="ruleForm.payeeBank" placeholder="请输入收款人开户行" :disabled="disabled"></el-input>
                        </el-form-item>
                        <el-form-item label="收款人银行账号" prop="payeeAccount">
                            <el-input v-model="ruleForm.payeeAccount" placeholder="请输入收款人银行账号" :disabled="disabled"></el-input>
                        </el-form-item>
                    </div>
                </div>

                <el-form-item label="申请原因" prop="leadingCadre">
