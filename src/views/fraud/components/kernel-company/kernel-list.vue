<template>
    <div class="pt20">
        ...
        <el-table :data="list" border tyle="width: 100%">
            ...
            <el-table-column prop="customerName" label="承建单位名称" width="280" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column prop="businessCategory" label="企业类别" show-overflow-tooltip>
                <template slot-scope="scope">
                    {{scope.row.businessCategory === 1?'核心企业':'业主企业' }}
                </template>
            </el-table-column>
            ...
            <el-table-column prop="parentUnit" label="上级单位" show-overflow-tooltip></el-table-column>
