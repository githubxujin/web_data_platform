                ...
                <div class="mod pb0">
                    <el-form :inline="true" size="medium">
                        ...
                        <el-form-item>
                            ...
                            <el-button type="info" @click="resetDia">重置</el-button>
                        </el-form-item>
                    </el-form>
                </div>
                <div class="mod">
                    <el-table :data="diaList">
...
export default {
    ...
    methods: {
        ...
        async getInfo (type) {
            ...
            let arr = this.$route.query.files
            arr = arr && arr.split(',')
            this.paramsDia.screenDetailId = this.$route.query.id;
        ...
        async initData (type) {
            ...
            this.params.assetId = this.detailData.id
