    ...
    <div>
        <el-form :inline="true" size="medium" class="el-serach-form">
            <el-form-item class="el-item-form-width">
                <el-select v-model="params.construction" clearable placeholder="承建单位名称" class=" el-item-form-width" filterable remote :remote-method="queryConstruction">
        ...
        <el-table :data="list">
            ...
            <el-table-column prop="construction" label="承建单位名称" show-overflow-tooltip :formatter="formatLabel"></el-table-column>
            ...
            <el-table-column prop="assignee" label="受让人" show-overflow-tooltip :formatter="formatLabel"></el-table-column>
            <el-table-column prop="assigneeType" label="受让人类型" show-overflow-tooltip :formatter="formatLabel">
            ...
            <el-table-column prop="secondaryUnit" label="二级单位" show-overflow-tooltip :formatter="formatLabel"></el-table-column>
            <el-table-column prop="secondDuration" label="合作时长" show-overflow-tooltip :formatter="formatLabel"></el-table-column>
            <el-table-column prop="primaryUnit" label="一级单位" show-overflow-tooltip :formatter="formatLabel"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        queryConstruction (query) {
            ...
            this.queryParams.construction = query
        ...
        remoteMethod () {
            this.ajax
                .json('/dcp/comm/zdw/construction/stats/vague', this.queryParams)
                .then(res => {
        ...
        getList () {
            this.ajax
                .json('/dcp/comm/zdw/construction/stats/page', this.params)
                .then(res => {
        ...
        async exportData () {
            await this.ajax
                .json('/dcp/comm/zdw/construction/stats/export', this.params, { type: 'export' })
