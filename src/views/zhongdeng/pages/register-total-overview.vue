<template>
    <div class="page">
        <div class="mainContent table-wrap mt20">
            <div class="mod pb0">
                <el-form :inline="true" size="medium">
                    ...
                    <el-form-item>
                        <el-input v-model.trim="params.sellerName" placeholder="质权人/受让人名称" clearable></el-input>
                    </el-form-item>
                    <el-form-item>
            ...
            <div class="mod">
                ...
                <el-table :data="list" style="width: 100%">
                    ...
                    <el-table-column prop="certNo" label="登记证明编号" width="220" :show-overflow-tooltip="true">
                        <template slot-scope="scope">
                            <a target="_blank" :href="gotoFile(scope.row.certFileId)">{{scope.row.certNo}}</a>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column prop="address" label="操作" align="center" fixed="right" width="120">
                        <template slot-scope="scope">
        ...
        <el-dialog v-if="descDialog" title="质押/转让财产描述" :center="true" :visible.sync="descDialog" :close-on-click-modal="false" width="700px" append-to-body>
            <div class="c_W">
                {{descDetail}}
            </div>
        </el-dialog>

        <el-dialog v-if="isDialog" title="详情" :visible.sync="isDialog" :close-on-click-modal="false" width="90%" append-to-body>
            <detail :id="curID" />
        </el-dialog>
    </div>
</template>
...
export default {
    ...
    components: {
        detail: () => import('./register-detail/detail.vue'),
    },
    data () {
        return {
            isDialog: false,
            ...
            params: {
                // registerType: '变更登记,',
                relatedCertNo: this.$route.query.certNo,
                sellerName: '',
                buyerName: '',
                registerStatus: ['2'],
                history: '1',
