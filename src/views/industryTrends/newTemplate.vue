<template>
    <div class="pb50">
        <div class="con-wrap">
            <h3 v-if="isNotification" @click="isNotification=false">新建模板<span><i class="iconfont icon-bianji"></i></span></h3>
            <el-input v-else class="tongzhi" v-model="params.name" maxlength="64" clearable autofocus placeholder="请输入模板名称"></el-input>
            <div class="inform">
                <div class="gmail-pro keyword">
                    ...
                    <el-button v-else class="button-new-tag button-new-tag1" size="small" type="primary" @click="showInput1">+ 新增接收邮箱</el-button>
                </div>
            </div>
        </div>
        <div class="con-wrap bot-wrap mt20">
            ...
            <el-button v-else class="button-new-tag" size="small" type="primary" @click="showInput">+ 新增</el-button>
        </div>
        <div class="fixed-bott">
            <el-button type="primary" size="medium" @click="goBack">返回</el-button>
            <el-button type="primary" size="medium" style="margin-left:20px;" @click="toSubmit">保存</el-button>
        </div>
    </div>
</template>
<script>
    ...
    methods: {
        ...
        toSubmit() {
            if (!this.params.name) {
                ...
                this.ajax
                    .json('/dcp/server/wx/article/notify/save', this.params)
                    .then(res => {
                        if (res.code === '200') {
