<template>
    <div class="pt20">
        <el-form :inline="true" ref="form" size="medium">
            ...
            <el-form-item>
                <el-input v-model="params.keyword" maxlength="100" clearable placeholder="关键字"></el-input>
            </el-form-item>
            <el-form-item>
        ...
        <ul class="list-content">
            <li v-for="(item, index) in list" :key="index">
                <a class="headline" :href="item.url" target="_blank" v-html="item.title" @click="alert(123)"></a>
        ...
        <el-pagination v-if="totalSize>params.pageSize" @size-change="handleSizeChange" @current-change="getList" :current-page="params.pageNum" :page-sizes="[10, 20, 30, 40]" :page-size="params.pageSize"
...
export default {
    ...
    methods: {
        ...
        getList (v) {
            ...
            this.$http('/dcp/server/wx/article/list', this.params, {
                type: 'get'
            }).then(res => {
                // console.log(res);
                this.list = res.data || []
                ...
                this.$nextTick(() => {
                    // console.log('1',this.$refs['txt-box']);
